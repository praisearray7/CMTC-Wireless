            ...
            <RepairServiceLayout
                ...
                breadcrumbs={
                    <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb" sx={{ mb: 2 }}>
                        ...
                        <Link href="/computer-repair" style={{ color: '#000000', textDecoration: 'none' }}>Computer Repair</Link>
                ...
                bottomContent={
                    <>
                        <Box sx={{ mb: 8, textAlign: 'center', maxWidth: '1200px', mx: 'auto' }}>
                            ...
                            <StaggerContainer childSelector=".laptop-brand-item">
                                <Grid container spacing={3} justifyContent="center">
                                    {laptopData.map((item) => {
                                        const linkPath = item.id === 'macbook-repair' ? '/macbook-repair' : `/laptop-repair/${item.id}`;
                                        return (
                                            <Grid size={{ xs: 12, sm: 6, md: 4 }} key={item.id} className="laptop-brand-item">
                                                <Paper
                                                    elevation={0}
                                                    sx={{
                                                        p: 3,
