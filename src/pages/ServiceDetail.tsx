        ...
        <Box sx={{ pb: 10 }}>
            ...
            <Container maxWidth="xl">
                ...
                <Box sx={{ maxWidth: '1200px', mx: 'auto', mb: 8 }}>
                    ...
                    <Typography variant="body1" paragraph sx={{ mb: 4, color: '#455a64' }}>
                    ...
                    <Typography variant="h5" gutterBottom sx={{ fontWeight: 600, color: '#2C3E50', mt: 4 }}>
                        What you need to know to streamline your iPhone repair:
                    </Typography>
                    <Box component="ul" sx={{ pl: 2, mb: 4, color: '#455a64' }}>
                    ...
                    <Typography variant="body1" paragraph sx={{ fontStyle: 'italic', color: '#546E7A', mb: 6 }}>
                    ...
                    <Box sx={{ mb: 6 }}>
                        ...
                        <Typography variant="body1" paragraph sx={{ color: '#455a64' }}>
