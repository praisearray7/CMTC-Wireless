                    ...
                    <Grid size={{ xs: 12, md: 8 }}>
                        <Box sx={{ mb: 6 }}>
                            ...
                            <Paper sx={{ p: 3, bgcolor: colors.white, borderRadius: 2, borderLeft: `4px solid ${colors.primary}` }}>
                                ...
                                <StaggerContainer childSelector=".warranty-list-item">
                                    <List>
                                        <ListItem className="warranty-list-item">
                        ...
                        <Box sx={{ mb: 6 }}>
                            ...
                            <StaggerContainer childSelector=".exclusion-item">
                                <Box>
                                    <Accordion className="exclusion-item" sx={{ boxShadow: 'none', border: '1px solid #e0e0e0', '&:before': { display: 'none' } }}>
