    ...
    return (
        <>
            <SEO
                ...
                description="Specialized repair for iMac, HP, Dell, and Lenovo All-in-One computers. SSD upgrades, screen replacement, and power supply repair."
            />
            <RepairServiceLayout
                faqCategory="aio"
                breadcrumbs={
