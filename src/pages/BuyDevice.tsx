            ...
            <Container maxWidth="xl">
                ...
                <Grid container spacing={4}>
                    ...
                    <Grid size={{ xs: 12, md: 8 }}>
                        ...
                        <StaggerContainer childSelector=".device-card">
                            <Grid container spacing={3}>
                                {inventory.map((item) => (
                                    <Grid size={{ xs: 12, sm: 6 }} key={item.id} className="device-card">
                                        <Card sx={{
                                            borderRadius: 3,
                ...
                <Box sx={{ mt: 12, textAlign: 'center' }}>
                    ...
                    <StaggerContainer childSelector=".value-prop-item">
                        <Grid container spacing={4}>
                            {[
                                {
                                ...
                                <Grid size={{ xs: 12, md: 4 }} key={index} className="value-prop-item">
                                    <Card
                                        elevation={0}
                                        sx={{
                                            height: '100%',
