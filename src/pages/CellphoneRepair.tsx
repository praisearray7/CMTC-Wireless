...
import { getRepairDetail } from '../data/modelSpecificDetails';
    ...
    <>
      ...
      <RepairServiceLayout
        ...
        breadcrumbs={
          <Breadcrumbs
            ...
            sx={{ mb: 2 }}
          >
            <Link href='/' style={{ color: '#546E7A', textDecoration: 'none' }}>
              Home
            </Link>
        ...
        bottomContent={
          <>
                ...
                <Grid container spacing={3} justifyContent='center'>
                  {cellphoneData.map((item) => (
                    <Grid
                      ...
                      key={item.id}
                      className='cellphone-brand-item'
                    >
                      <Link
                      ...
                      >
                        ...
                        >
                          ...
                          <Typography
                            variant='h6'
                            sx={{ color: '#1a1a1a', fontWeight: 600, textAlign: 'center' }}
                          >
                            {item.title}
                          </Typography>
                        </Paper>
            ...
            <Box sx={{ mb: 8 }}>
              <Typography
                variant='h4'
                sx={{ fontWeight: 700, color: '#333', mb: 4, textAlign: 'center' }}
              >
                Most Popular Repairs
              </Typography>
              <StaggerContainer childSelector='.most-popular-repair-item'>
                <Grid container spacing={3}>
                  {[
                    ...
                    const item = getRepairDetail(type, index);
                    return (
                      <Grid
                        size={{ xs: 12, sm: 6, md: 4 }}
                        key={index}
                        className='most-popular-repair-item'
                      >
                        <RepairCard
                          title={item.title}
                  ...
                  {[
                    {
                      issue: "Won't Charge",
                      solution:
                        'Common on Samsungs and Motos. We solder new USB-C ports on the motherboard.',
                      icon: <Zap size={24} />
                    },
                    {
                      issue: 'Broken Screen / No Display',
                      solution:
                        'OLED screens are delicate. We replace the full assembly for a factory-fresh look.',
                      icon: <Smartphone size={24} />
                    },
                    {
                      issue: 'Boot Loop / Stuck on Logo',
                      solution:
                        'Software corruption. We can re-flash firware or replace the battery if voltage is low.',
                      icon: <RefreshCw size={24} />
                    },
                    {
                      issue: "Can't Hear Calls",
                      solution:
                        'Earpiece speaker mesh gets clogged. We clean or replace the receiver speaker.',
                      icon: <Volume2 size={24} />
                    },
                    {
                      issue: 'Network Issues',
                      solution:
                        'Weak signal? It could be a loose antenna cable or damaged SIM reader.',
                      icon: <Wifi size={24} />
                    },
                    {
                      issue: 'Back Glass Smashed',
                      solution:
                        'We carefully remove broken glass to keep the wireless charging coil safe.',
      ...
      >
        <Typography
          variant='h2'
          component='h1'
          sx={{ fontWeight: 400, color: '#333', mb: 2, fontFamily: 'serif' }}
        >
          Cell Phone Repair
        </Typography>
        ...
        <Typography variant='body1' paragraph sx={{ color: '#546E7A', mb: 3, lineHeight: 1.6 }}>
          Looking for a reliable cell phone repair shop? We repair Samsung, Google Pixel, Motorola,
          OnePlus, Nothing, Xiaomi, Realme, Oppo, Vivo, and many other brands. Whether you have a
          broken screen, bad battery, or charging issues, we can help.
        </Typography>
        ...
        <Box component='ul' sx={{ pl: 2, mb: 3, color: '#546E7A' }}>
          <Box component='li'>
            <Typography variant='body1'>Cracked Screen Repair</Typography>
          </Box>
          <Box component='li'>
          ...
          <Box component='li'>
            <Typography variant='body1'>Software Troubleshooting</Typography>
          </Box>
          <Box component='li'>
            <Typography variant='body1'>Data Recovery</Typography>
          </Box>
        </Box>
      </RepairServiceLayout>
    </>
