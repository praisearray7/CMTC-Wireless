    ...
    return (
        <>
            <SEO
                ...
                description="Expert repair services for Apple Watch, Samsung Galaxy Watch, and more. Screen replacement, battery fixes, and water damage repair in Minneapolis."
            />
            <RepairServiceLayout
