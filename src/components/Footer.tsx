          ...
          <Grid container spacing={6}>
            ...
            <Grid size={{ xs: 12, md: 3 }} className='footer-column'>
              <Stack spacing={3}>
                ...
                <Typography
                  variant='body1'
                  sx={{ color: '#e5e7eb', lineHeight: 1.7, maxWidth: '90%' }}
                >
                  Trusted by thousands for fast, reliable device repairs. We're here to keep you
                  connected with expert service and quality parts.
                </Typography>
                <Stack direction='row' spacing={1.5}>
                  {[
                    {
                      icon: <FacebookIcon />,
                      href: 'https://www.facebook.com/MetroBrooklynParkMN10222653/',
                      label: 'Facebook'
                    },
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }} className='footer-column'>
              <Typography
                variant='h6'
                sx={{ fontWeight: 700, mb: 3, letterSpacing: '0.5px', color: colors.white }}
              >
                Quick Links
              </Typography>
              <Stack spacing={1.5}>
              ...
              <Stack spacing={2.5}>
                ...
                <Box>
                  ...
                  <MuiLink
                    ...
                    underline='hover'
                    sx={{ color: '#f3f4f6', '&:hover': { color: colors.primaryLight } }}
                  >
