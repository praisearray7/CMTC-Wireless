import{j as e,B as i,c as b,C as f,T as r,S as z,G as d,P as D,L as N,g as x,r as c,i as u,a as U,b as $,d as A}from"./index-B-YwnTUl.js";import{C as X,F as Y}from"./FAQ-CbQadwOF.js";import{B as H,V as L}from"./VerifiedUserOutlined-DBAQGZ5u.js";import{T as Q}from"./ThumbUpOutlined-DNzBYavG.js";import{G as K,P as q,T as _}from"./Timer-B7UaiKfq.js";import{V as J}from"./VerifiedUser-ChZUy-bF.js";import{C as ee,G as te}from"./GoogleReviews-1d_4jZm4.js";import{F as g}from"./FadeIn-BnmKF-TH.js";import{S as oe}from"./SEO-CubTxGeC.js";import{C as G}from"./Card-CdWyXoWR.js";import{C as re}from"./CardContent-rX1sXSxo.js";import"./AccordionSummary-BfFsU2VU.js";import"./useControlled-BLVV8XrD.js";import"./Rating-o3eDxINB.js";const ie=[{title:"iPad Repair",image:"https://www.gophermods.com/wp-content/uploads/2020/04/iPad-Repair-by-Gophermods-200x200-1.jpg",link:"/ipad-repair"},{title:"MacBook Repair",image:"https://www.gophermods.com/wp-content/uploads/2018/03/MacBook-Repair.jpg",link:"/macbook-repair"},{title:"Laptop Repair",image:"https://www.gophermods.com/wp-content/uploads/2019/02/Chromebook-Repair.jpg",link:"/laptop-repair"},{title:"iPhone Repair",image:"https://www.gophermods.com/wp-content/uploads/2025/06/iPhone-16-Repairs-Minneapolis.jpg",link:"/iphone-repair"},{title:"Computer Repair",image:"https://www.gophermods.com/wp-content/uploads/2014/11/mac-200x200.jpg",link:"/computer-repair"},{title:"Cell Phone Repair",image:"https://www.gophermods.com/wp-content/uploads/2025/06/Google-Pixel-Repairs-Minneapolis.jpg",link:"/cell-phone-repair"},{title:"Samsung Repair",image:"https://www.gophermods.com/wp-content/uploads/2021/01/Galaxy-Note-20.jpg",link:"/contact-us",state:{deviceModel:"Samsung"}},{title:"Smart Watch Repair",image:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/watch-card-40-hermes-ultra-202509_GEO_US?wid=680&hei=528&fmt=jpeg&qlt=90&.v=Ly93VWF6a1dGOWJLL3RMM0s0eGZ6bGptdm4xZHhxZWZzUlhoOU9Da0hNNVU4aHdGN0xlWGtoZjR6dnFUWE9VVTV0VzZXemQ1ZkRzK0p5ZFBxZERkQ3o2K3c3eDN1QlVKV09nQzhyNmV5TTNjeFVjd0E0NEk3ZEplNUNxd0pRazY",link:"/contact-us",state:{deviceModel:"Smart Watch"}}],se=()=>e.jsxs(i,{sx:{mb:10},children:[e.jsxs(i,{sx:{bgcolor:b.primary,py:8,position:"relative",textAlign:"center",mb:8},children:[e.jsx(f,{maxWidth:"xl",children:e.jsx(r,{variant:"h4",sx:{color:"#fff",fontWeight:400,fontFamily:"serif",maxWidth:"md",mx:"auto"},children:"We are a depot repair and lifecycle partner for iPhone, iPad, Mac, Chromebooks, and Windows laptops."})}),e.jsx(i,{sx:{position:"absolute",bottom:-20,left:"50%",transform:"translateX(-50%)",width:0,height:0,borderLeft:"25px solid transparent",borderRight:"25px solid transparent",borderTop:`25px solid ${b.primary}`}})]}),e.jsx(f,{maxWidth:"xl",children:e.jsx(z,{childSelector:".service-grid-item",children:e.jsx(d,{container:!0,spacing:4,justifyContent:"center",children:ie.map(t=>e.jsx(d,{size:{xs:6,sm:4,md:3},className:"service-grid-item",children:e.jsxs(D,{elevation:0,component:N,to:t.link,state:t.state,sx:{display:"flex",flexDirection:"column",alignItems:"center",textDecoration:"none",cursor:"pointer",bgcolor:"transparent",transition:"transform 0.3s ease","&:hover":{transform:"translateY(-5px)"}},children:[e.jsx(i,{component:"img",src:x(t.image),alt:t.title,sx:{width:"100%",maxWidth:180,height:"auto",aspectRatio:"1/1",objectFit:"contain",mb:2}}),e.jsx(r,{variant:"h6",sx:{color:"#000000",fontWeight:400,fontSize:"1rem",textAlign:"center"},children:t.title})]})},t.title))})})})]});function ae({images:t,intervalMs:y=5e3,height:W=650,showBottomBar:o=!0}){const[s,P]=c.useState(0),[j,C]=c.useState(null),[w,R]=c.useState(!1),[I,T]=c.useState(!1),[p,M]=c.useState("pixel"),[v,S]=c.useState(6),[h,k]=c.useState(10),Z=c.useRef(null),O=c.useMemo(()=>Array.from({length:200},()=>Math.random()),[]);c.useEffect(()=>{if(t.length<=1||I||w)return;const n=setInterval(()=>{B((s+1)%t.length)},y);return()=>clearInterval(n)},[s,t.length,y,I,w]);const B=n=>{if(n===s||w)return;const a=["pixel","column","row","fade","twist","spin","blinds","zoomIn","zoomOut"],l=a[Math.floor(Math.random()*a.length)];M(l),l==="pixel"||l==="twist"||l==="spin"?(S(6),k(10)):l==="column"||l==="blinds"?(S(1),k(12)):l==="row"?(S(8),k(1)):(S(1),k(1)),C(n),R(!0),setTimeout(()=>{P(n),C(null),R(!1)},1400)},E=n=>p==="pixel"||p==="twist"||p==="spin"?O[n]*.6:p==="column"||p==="blinds"?n*.05:p==="row"?n*.08:0;if(!t||t.length===0)return null;const V=v*h;return e.jsxs("div",{ref:Z,onMouseEnter:()=>T(!0),onMouseLeave:()=>T(!1),style:m.sliderWrapper(W),children:[e.jsx("div",{style:m.slideStack,children:e.jsxs("figure",{className:"hero-slide active",children:[e.jsx("img",{src:t[s],alt:`Slide ${s+1}`,className:"hero-image ken-burns",draggable:!1}),e.jsx("div",{style:m.overlay})]})}),w&&j!==null&&e.jsx("div",{style:m.gridContainer,children:Array.from({length:V}).map((n,a)=>{const l=a%h,F=Math.floor(a/h);return e.jsx("div",{className:`pixel-cell ${p}`,style:{width:`${100/h}%`,height:`${100/v}%`,left:`${l*(100/h)}%`,top:`${F*(100/v)}%`,animationDelay:`${E(a)}s`},children:e.jsx("img",{src:t[j],alt:"",style:{position:"absolute",width:`${h*100}%`,height:`${v*100}%`,left:`-${l*100}%`,top:`-${F*100}%`,maxWidth:"none",objectFit:"cover"},draggable:!1})},a)})}),e.jsx("div",{style:m.dotsWrapper(o),children:t.map((n,a)=>e.jsx("button",{onClick:()=>B(a),"aria-label":`Go to slide ${a+1}`,className:`hero-dot ${a===(j!==null?j:s)?"active":""}`,style:{outline:"none"}},a))}),o&&e.jsx("div",{style:m.bottomBar,children:e.jsx("h2",{style:m.bottomText,children:"Get Your Repair Started"})}),e.jsx("style",{children:`
