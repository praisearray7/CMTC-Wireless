import{j as e,B as r,C as u,T as i,G as c,P as B,L as A,g as f,r as l,i as g,a as N,S as O,b as T}from"./index-BL2N5TND.js";import{B as V,V as U,C as X}from"./VerifiedUserOutlined-DtWWkcqX.js";import{T as $}from"./ThumbUpOutlined-C-J3QZoI.js";import{G as Y,P as H,T as L}from"./Timer-CzOpn8ar.js";import{V as Q}from"./VerifiedUser-DhUX3aue.js";import{C as K,G as q}from"./GoogleReviews-ZD64-TsK.js";import{F as _}from"./FAQ-VJBEEhLg.js";import{S as J}from"./SEO-BBQApCBj.js";import{C as F}from"./Card-O2faElhV.js";import{C as ee}from"./CardContent-BO-cI7jQ.js";import"./Rating-CHTvyc1H.js";import"./useControlled-Bc8FOCeJ.js";import"./AccordionSummary-BJbm07pb.js";const te=[{title:"iPad Repair",image:"https://www.gophermods.com/wp-content/uploads/2020/04/iPad-Repair-by-Gophermods-200x200-1.jpg",link:"/ipad-repair"},{title:"MacBook Repair",image:"https://www.gophermods.com/wp-content/uploads/2018/03/MacBook-Repair.jpg",link:"/macbook-repair"},{title:"Laptop Repair",image:"https://www.gophermods.com/wp-content/uploads/2019/02/Chromebook-Repair.jpg",link:"/laptop-repair"},{title:"iPhone Repair",image:"https://www.gophermods.com/wp-content/uploads/2025/06/iPhone-16-Repairs-Minneapolis.jpg",link:"/iphone-repair"},{title:"Computer Repair",image:"https://www.gophermods.com/wp-content/uploads/2014/11/mac-200x200.jpg",link:"/computer-repair"},{title:"Cell Phone Repair",image:"https://www.gophermods.com/wp-content/uploads/2025/06/Google-Pixel-Repairs-Minneapolis.jpg",link:"/cell-phone-repair"},{title:"Samsung Repair",image:"https://www.gophermods.com/wp-content/uploads/2021/01/Galaxy-Note-20.jpg",link:"/contact-us",state:{deviceModel:"Samsung"}},{title:"Smart Watch Repair",image:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/watch-card-40-hermes-ultra-202509_GEO_US?wid=680&hei=528&fmt=jpeg&qlt=90&.v=Ly93VWF6a1dGOWJLL3RMM0s0eGZ6bGptdm4xZHhxZWZzUlhoOU9Da0hNNVU4aHdGN0xlWGtoZjR6dnFUWE9VVTV0VzZXemQ1ZkRzK0p5ZFBxZERkQ3o2K3c3eDN1QlVKV09nQzhyNmV5TTNjeFVjd0E0NEk3ZEplNUNxd0pRazY",link:"/contact-us",state:{deviceModel:"Smart Watch"}}],oe=()=>e.jsxs(r,{sx:{mb:10},children:[e.jsxs(r,{sx:{bgcolor:"#78E335",py:8,position:"relative",textAlign:"center",mb:8},children:[e.jsx(u,{maxWidth:"xl",children:e.jsx(i,{variant:"h4",sx:{color:"#fff",fontWeight:400,fontFamily:"serif",maxWidth:"md",mx:"auto"},children:"We are a depot repair and lifecycle partner for iPhone, iPad, Mac, Chromebooks, and Windows laptops."})}),e.jsx(r,{sx:{position:"absolute",bottom:-20,left:"50%",transform:"translateX(-50%)",width:0,height:0,borderLeft:"25px solid transparent",borderRight:"25px solid transparent",borderTop:"25px solid #78E335"}})]}),e.jsx(u,{maxWidth:"xl",children:e.jsx(c,{container:!0,spacing:4,justifyContent:"center",children:te.map(t=>e.jsx(c,{size:{xs:6,sm:4,md:3},children:e.jsxs(B,{elevation:0,component:A,to:t.link,state:t.state,sx:{display:"flex",flexDirection:"column",alignItems:"center",textDecoration:"none",cursor:"pointer",bgcolor:"transparent",transition:"transform 0.3s ease","&:hover":{transform:"translateY(-5px)"}},children:[e.jsx(r,{component:"img",src:f(t.image),alt:t.title,sx:{width:"100%",maxWidth:180,height:"auto",aspectRatio:"1/1",objectFit:"contain",mb:2}}),e.jsx(i,{variant:"h6",sx:{color:"#666",fontWeight:400,fontSize:"1rem",textAlign:"center"},children:t.title})]})},t.title))})})]});function re({images:t,intervalMs:b=5e3,height:o=650,showBottomBar:d=!0}){const[m,G]=l.useState(0),[y,k]=l.useState(null),[j,C]=l.useState(!1),[z,W]=l.useState(!1),[p,E]=l.useState("pixel"),[w,v]=l.useState(6),[h,S]=l.useState(10),D=l.useRef(null),P=l.useMemo(()=>Array.from({length:200},()=>Math.random()),[]);l.useEffect(()=>{if(t.length<=1||z||j)return;const a=setInterval(()=>{R((m+1)%t.length)},b);return()=>clearInterval(a)},[m,t.length,b,z,j]);const R=a=>{if(a===m||j)return;const s=["pixel","column","row","fade","twist","spin","blinds","zoomIn","zoomOut"],n=s[Math.floor(Math.random()*s.length)];E(n),n==="pixel"||n==="twist"||n==="spin"?(v(6),S(10)):n==="column"||n==="blinds"?(v(1),S(12)):n==="row"?(v(8),S(1)):(v(1),S(1)),k(a),C(!0),setTimeout(()=>{G(a),k(null),C(!1)},1400)},M=a=>p==="pixel"||p==="twist"||p==="spin"?P[a]*.6:p==="column"||p==="blinds"?a*.05:p==="row"?a*.08:0;if(!t||t.length===0)return null;const Z=w*h;return e.jsxs("div",{ref:D,onMouseEnter:()=>W(!0),onMouseLeave:()=>W(!1),style:x.sliderWrapper(o),children:[e.jsx("div",{style:x.slideStack,children:e.jsxs("figure",{className:"hero-slide active",children:[e.jsx("img",{src:t[m],alt:`Slide ${m+1}`,className:"hero-image ken-burns",draggable:!1}),e.jsx("div",{style:x.overlay})]})}),j&&y!==null&&e.jsx("div",{style:x.gridContainer,children:Array.from({length:Z}).map((a,s)=>{const n=s%h,I=Math.floor(s/h);return e.jsx("div",{className:`pixel-cell ${p}`,style:{width:`${100/h}%`,height:`${100/w}%`,left:`${n*(100/h)}%`,top:`${I*(100/w)}%`,animationDelay:`${M(s)}s`},children:e.jsx("img",{src:t[y],alt:"",style:{position:"absolute",width:`${h*100}%`,height:`${w*100}%`,left:`-${n*100}%`,top:`-${I*100}%`,maxWidth:"none",objectFit:"cover"},draggable:!1})},s)})}),e.jsx("div",{style:x.dotsWrapper(d),children:t.map((a,s)=>e.jsx("button",{onClick:()=>R(s),"aria-label":`Go to slide ${s+1}`,className:`hero-dot ${s===(y!==null?y:m)?"active":""}`,style:{outline:"none"}},s))}),d&&e.jsx("div",{style:x.bottomBar,children:e.jsx("h2",{style:x.bottomText,children:"Get Your Repair Started"})}),e.jsx("style",{children:`
